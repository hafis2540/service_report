            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" action="checklogin.php" id="login" method="POST" name="formlogin">
                    <div class="form-group">
                      <input type="username" name="username" id="username" class="form-control form-control-user" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
